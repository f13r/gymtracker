...
- `/handoff` — Compacts the current conversation into a handoff doc for another agent or session to pick up.
- `/remote-env` — Sets up the remote dev environment. Run this early if you're working outside localhost.
