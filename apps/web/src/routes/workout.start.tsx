...
import { Plus, Dumbbell, Play, Zap, Trash2, CalendarDays } from 'lucide-react'
        ...
        {templates.length === 0 ? (
          <div className="flex flex-col items-center justify-center gap-4 py-20">
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground mt-1 text-sm">Create a template to plan your workouts</p>
            </div>
            <button
